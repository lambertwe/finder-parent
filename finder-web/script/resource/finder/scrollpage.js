...
URLParameter.getParameter = function(name) {
...
URLParameter.parse = function(query) {
    var parameters = {};
...
URLParameter.serialize = function(parameters) {
    var a = [];
    if(parameters != null) {
...
URLParameter.remove = function(url, name) {
    var s = url;
...
ScrollPage.getPageUrl = function(url, parameters, remove){
    ...
    if(result != null) {
        ...
        for(var i in parameters) {
            ...
            if(remove != false) {
                result = URLParameter.remove(result, name);
            }
