...
public class ClusterUtil {
    ...
    public static String build(Cluster cluster) {
        ...
        buffer.append("<cluster version=\"");
        buffer.append(cluster.getVersion());
    ...
    public static StringBuilder build(Host host, StringBuilder buffer, String indent) {
        ...
        if(StringUtil.notBlank(host.getName())) {
            buffer.append(" name=\"");
            buffer.append(Html.encode(host.getName()));
            buffer.append("\"");
        }

        if(StringUtil.notBlank(host.getDisplayName())) {
            buffer.append(" displayName=\"");
            buffer.append(Html.encode(host.getDisplayName()));
            buffer.append("\"");
        }

        if(StringUtil.notBlank(host.getUrl())) {
            buffer.append(" url=\"");
            buffer.append(Html.encode(host.getUrl()));
            buffer.append("\"");
        }
        buffer.append(">").append(CRLF);
    ...
    private static StringBuilder build(Workspace workspace, StringBuilder buffer, String indent) {
        ...
        if(StringUtil.notBlank(workspace.getName())) {
            buffer.append(" name=\"");
            buffer.append(Html.encode(workspace.getName()));
            buffer.append("\"");
        }

        if(StringUtil.notBlank(workspace.getDisplayName())) {
            buffer.append(" displayName=\"");
            buffer.append(Html.encode(workspace.getDisplayName()));
            buffer.append("\"");
        }

        if(StringUtil.notBlank(workspace.getWork())) {
            buffer.append(" work=\"");
            buffer.append(Html.encode(workspace.getWork()));
            buffer.append("\"");
        }

        if(StringUtil.notBlank(workspace.getCharset())) {
            buffer.append(" charset=\"");
            buffer.append(Html.encode(workspace.getCharset()));
            buffer.append("\"");
        }
