...
public class Path {
     ...
     * @return boolean
     */
    public static boolean contains(String parent, String path) {
        return contains(parent, path, false);
    }
     ...
     * @return boolean
     */
    public static boolean contains(String parent, String path, boolean full) {
        if(full) {
            String p1 = getStrictPath(parent);
            String p2 = getStrictPath(path);
            return p2.startsWith(p1);
        }

        String p1 = join(parent, "");
        String p2 = join(parent, path);
        return p2.startsWith(p1);
    }
